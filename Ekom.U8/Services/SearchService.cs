...
using Umbraco.Web;
using static Ekom.Core.Utilities.SearchHelper;
...
namespace Ekom.Services
{
    class SearchService : ISearchService
    {
        ...
        public IEnumerable<UmbracoContent> QueryCatalog(string query, out long totalRecords)
        {
            ...
            {
                _logger.Error<SearchService>(ex, "Failed to query catalog search service. Query: " + query);
                _logger.Info<SearchService>(luceneQuery.ToString());
            }
